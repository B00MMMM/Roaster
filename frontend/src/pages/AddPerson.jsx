    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-orange-500/30 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-2xl">
          ...
          {showForm && (
            <form onSubmit={handleSubmit} className="bg-slate-900/50 backdrop-blur-md rounded-xl p-4 sm:p-6 mb-6 border border-slate-700/50 shadow-xl">
                ...
                <div ref={skinColorRef}>
                  ...
                  <div className="relative">
                    ...
                    {showSkinColorDropdown && (
                      <div 
                        className="absolute top-full left-0 right-0 mt-2 bg-slate-800/95 backdrop-blur-md rounded-xl border border-slate-600/50 shadow-2xl z-30 max-h-60 overflow-y-auto scrollbar-hide"
                        style={{
              ...
              <div className="lg:col-span-2 mt-4">
                ...
                <div className="relative">
                  ...
                  {showTraitSelector && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-slate-800/95 backdrop-blur-md rounded-xl p-4 z-20 border border-slate-600/50 shadow-2xl max-h-80">
